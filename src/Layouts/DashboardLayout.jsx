...

                    {
                        currentUser.isAdmin ? <ul className='flex flex-col gap-5'>
                            ...
                            <li>
                                ...
                                }} to='adminHome' className='flex items-center gap-2'> <FaHome></FaHome>  Admin Home</NavLink>
                            </li>
                            ...
                            <li>
                                ...
                                }} to='manageService' className='flex items-center gap-2'> <PiSquaresFourBold /> Manage Service</NavLink>
                            </li>
                            ...
                            <ul className='flex flex-col gap-5'>
                                ...
                                <li>
                                    ...
                                    }} to='userHome' className='flex items-center gap-2'> <FaHome></FaHome>  User Home</NavLink>
                                </li>
